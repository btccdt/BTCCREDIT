...
uint256 hashGenesisBlock("0xe14cf14ef26699c83a3bd328273d4d648b6988ee9cc52086ff7d045a2efc8f56");
...
const string strMessageMagic = "btccdt Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 1 * 60 * 60; // btccdt: 1 hour
static const int64 nTargetSpacing = 1; // btccdt: 1 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal btccdt miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "btccdt", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
	...
	// vMerkleTree: 5a2e19825b
        ...
        block.nVersion = 1;
        block.nTime    = 1524293577;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 3286521;
