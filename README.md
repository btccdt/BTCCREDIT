BITCOIN CREDIT (BTCCDT) - a 'faster' version of Litecoin which also uses scrypt
as a proof of work scheme and is intended for microtransactions.
 - 1 seconds block targets: beat that MinCoin! ;)
 - 42 007 680 total coins
 - no subsidy within the first 3 days and after approximately 5 years;
    in between: 100 coins per generated block
...
So actually, this 'new' coin exists for the following reasons:
 - BTCCDT proves that really anyone(!) can start a Litecoin/Bitcoin based currency
...
Finally, I only tested the command line server/tool 'BTCCDT' for the
